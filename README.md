...
| JDK | `17` |
| Coordinates | `io.github.easy4j:okhttp3-spring-boot-starter:1.0.3.RELEASE` |
...
| `OkHttpHostnameVerifier` bean | ✅ Stable | Auto-registered via OkHttp3AutoConfiguration, OkHttp3EndpointAutoConfiguration |
...
| `SSLSocketFactory` | classpath + property | not created |
...
| `CertificatePinner` | classpath + property | not created |
| `CookieJar` | classpath + property | not created |
| `Dns` | classpath + property | not created |
| `EventListener` | classpath + property | not created |
| `SocketFactory` | classpath + property | not created |
| `Builder` | classpath + property | not created |
| `ConnectionPool` | classpath + property | not created |
...
| `OkHttp3MetricsInterceptor` | classpath + property | not created |

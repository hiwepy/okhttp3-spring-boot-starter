...
> **Current Version**：`1.0.8.RELEASE`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:okhttp3-spring-boot-starter:1.0.8.RELEASE` |
...
| Property Binding | ✅ Stable | Binds `okhttp3.*` to `OkHttp3PoolProperties` |
| `RequestHeaderInterceptor` bean | ✅ Stable | Auto-registered via OkHttp3AutoConfiguration, OkHttp3EndpointAutoConfiguration |
